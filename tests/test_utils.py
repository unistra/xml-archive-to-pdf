...
class UtilsTest(unittest.TestCase):
    ...
    def test_write_table(self):
        ...
        # Column titles
        self.assertEqual(Story[2].__dict__["_cellvalues"][0][0].text, "nom")
        self.assertEqual(Story[2].__dict__["_cellvalues"][0][1].text, "type")
        self.assertEqual(Story[2].__dict__["_cellvalues"][0][2].text, "portée")
        self.assertEqual(Story[2].__dict__["_cellvalues"][0][3].text, "dégât")
        self.assertEqual(Story[2].__dict__["_cellvalues"][0][4].text, "élément")
        self.assertEqual(Story[2].__dict__["_cellvalues"][0][5].text, "rareté")
        self.assertEqual(Story[2].__dict__["_cellvalues"][0][6].text, "prix")
        self.assertEqual(Story[2].__dict__["_cellvalues"][0][7].text, "qualité")
        # First row
